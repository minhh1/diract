...
export const AUDIENCES: Record<string, AudienceContent> = {
  "law-firm-au": {
    ...
    subheadline: "Diract brings your matters, time, trust accounting, and client communication into one system — purpose-built for Australian firms, with automatic time capture and a shared precedent library from day one.",
