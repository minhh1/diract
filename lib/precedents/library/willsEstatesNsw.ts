...
export const WILLS_ESTATES_NSW_PRECEDENTS: PrecedentSeed[] = [
  ...
  },
  {
    ...
    segments: [
      ...
      text("\n\nREGISTRATION\n\nIf your attorney will need to deal with land, for example selling or mortgaging your property, the power must be registered with NSW Land Registry Services. We recommend registering it now rather than at a time of crisis."),
    ],
  },
  {
  ...
  },
  {
    ...
    matterTypes: WILLS,
    aiInstructions:
      "Draft a letter explaining an executor's duties. Cover: securing and insuring assets; identifying all assets and liabilities; not mixing estate money with their own; keeping proper accounts; acting impartially between beneficiaries; paying debts before distributing; lodging any outstanding tax returns and a date-of-death return; and personal liability for getting it wrong. Also explain they are entitled to be reimbursed reasonable expenses and to obtain professional help at estate cost. Reassure the reader: most new executors find this daunting.",
    segments: [
