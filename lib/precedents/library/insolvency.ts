...
export const INSOLVENCY_PRECEDENTS: PrecedentSeed[] = [
  ...
  },
  {
    ...
    matterTypes: INSOLVENCY,
    aiInstructions:
      "Draft a covering letter serving a bankruptcy notice on a judgment debtor. Identify the judgment and the amount, explain that failure to comply within the statutory period is an act of bankruptcy on which a creditor's petition may be founded, note that the debtor may apply to set the notice aside or to extend time (and that strict time limits apply, generally shorter than the compliance period itself), recommend they obtain urgent advice, and briefly note the practical consequences of bankruptcy itself (restrictions on travel overseas, on acting as a company director, on obtaining credit, and that a trustee takes control of the bankrupt's property) so the recipient understands what is actually at stake, not just the legal mechanism. Note that payment or a satisfactory arrangement will resolve it.",
    segments: [
      ...
      text("\n\nWHAT THIS MEANS\n\nIf you do not comply with the notice within the period stated in it, you will commit an act of bankruptcy. Our client may then present a creditor's petition seeking a sequestration order making you bankrupt.\n\nWHAT BANKRUPTCY WOULD MEAN FOR YOU\n\nIf you are made bankrupt: a trustee takes control of your property and divisible income; you generally cannot travel overseas without the trustee's permission; you cannot act as a director of a company; and the bankruptcy is recorded on the National Personal Insolvency Index, typically for several years, affecting your ability to obtain credit.\n\nYOUR OPTIONS\n\n1. Pay the amount claimed.\n2. Make an arrangement with our client that it is prepared to accept.\n3. Apply to the Court to set aside the notice, or to extend the time for compliance. An application to set aside must generally be made well before the compliance period in the notice expires -- do not wait until close to that date.\n\nWE STRONGLY RECOMMEND YOU OBTAIN LEGAL ADVICE IMMEDIATELY.\n\nIf you wish to discuss payment, contact us without delay. Our client would prefer to be paid than to make you bankrupt."),
    ],
    requiresReview: true,
    reviewNote:
