...
export const STATES_REMAINING_PRECEDENTS: PrecedentSeed[] = [
  ...
  // ── Minor civil: SA / WA / TAS ──────────────────────────────────
  {
    ...
    segments: [
      ...
      text("\n\nWHAT TO EXPECT\n\n"),
      field("next_steps", "What happens next", "We expect this matter will first be listed for a conciliation or directions hearing, at which the Tribunal will explore an agreed resolution before setting the matter down for a final hearing if that is unsuccessful."),
  ...
  },
  {
    ...
    segments: [
      ...
      text("\n\nWHAT TO EXPECT\n\n"),
      field("next_steps", "What happens next", "We expect the Court will list this claim for a hearing at which the Magistrate will hear both sides informally. There is generally no separate directions or mediation stage in this jurisdiction, so the parties should be ready to present their evidence at the first listing."),
  ...
  },
  {
    ...
    segments: [
      ...
      text("\n\nWHAT TO EXPECT\n\n"),
      field("next_steps", "What happens next", "We expect the Court will list this claim for a mediation or directions hearing in the first instance, with a final hearing to follow only if the matter does not resolve."),
      text("\n\nCOSTS\n\n"),
