...
import {
  ...
  Inbox, Paperclip, Reply, X, Check, ExternalLink,
} from "lucide-react";
...
export default function GmailPage() {
  ...
  const handleAssign = async (messageId: string, projectId: string) => {
    ...
    const projectName = project ? getProjectLabel(project) : '';
  ...
  if (connected === false) {
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-[#F9FAFB] font-sans">
      <div className="bg-white border border-slate-200 rounded-[40px] p-12 max-w-md w-full mx-4 text-center shadow-sm">
        ...
        <a href="/api/gmail/auth" className="flex items-center justify-center gap-3 w-full py-4 bg-slate-900 text-white rounded-full font-bold text-[13px] hover:bg-slate-700 transition-all">Connect with Google</a>
      ...
      <header className="bg-white border-b border-slate-100 shrink-0 px-8 pt-8 pb-4">
        <div className="flex items-center justify-between mb-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-2 bg-slate-900 text-white rounded-full text-[11px] font-bold hover:bg-black transition-all"
            >
        ...
        <div className="relative mb-4">
          ...
          <input
            ...
            onKeyDown={e => {
              if (e.key === 'Enter' && search) fetchMessages(search);
            }}
            className="w-full bg-slate-50 border border-slate-100 rounded-2xl py-3 pl-11 pr-4 text-sm font-medium outline-none focus:ring-4 focus:ring-black/5 transition-all"
          />
        </div>
          ...
          {loading ? (
            ...
            <div className="flex-1 overflow-y-auto divide-y divide-slate-50">
              {filteredMessages.map(msg => {
                const assignedProjectId = assignedMap[msg.id];
            ...
            <div className="p-6 border-b border-slate-100 shrink-0">
              ...
              <div className="flex items-center gap-3">
                ...
                <select
                  ...
                  onChange={e => {
                    if (e.target.value) handleAssign(selectedMessage.id, e.target.value);
                  }}
