// app/api/residual-land-solver-pages/route.ts
// Admin-side (auth required). Create/list public, shareable Residual Land
// Solver links for a project (residual_land_solver_pages -- see
// supabase/migrations/20260801190000_residual_land_solver_pages.sql).
// Mirrors app/api/finance-model-pages/route.ts.
