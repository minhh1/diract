...
// app/public/documents/[pageId]/page.tsx). DELETE removes a document
// template: the stored .docx object, then the DB row (cascades to
...
export async function PATCH(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const { error } = await admin.from("document_templates")
