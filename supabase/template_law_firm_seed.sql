...
BEGIN
  ...
  SELECT v_template_id, v_timefees_table_id, 'Time Entry', 'time-entry', 'Clock', '#7c3aed', 0, '[
    ...
    {"id":"te8","type":"grid","layout":{"x":0,"y":10,"w":12,"h":14},"config":{"fieldIds":["matter","staff","task_code","activity_code","description","rate","duration_hours","amount","billable","status","invoice"],"showTotalsRow":true,"totalsColumns":["duration_hours","amount","billable"],"emptyRowCount":5}},
