...
BEGIN
  ...
  SELECT v_template_id, v_timefees_table_id, 'Time Entry', 'time-entry', 'Clock', '#7c3aed', 0, '[
    ...
    {"id":"te7","type":"chart","layout":{"x":0,"y":6,"w":12,"h":4},"config":{"dateFieldId":"date","series":[{"label":"Hours Worked","valueFieldId":"duration_hours","aggregate":"sum","conditions":[]},{"label":"Billable Hours","valueFieldId":"duration_hours","aggregate":"sum","conditions":[{"fieldId":"billable","operator":"eq","value":true}]},{"label":"Non-billable Hours","valueFieldId":"duration_hours","aggregate":"sum","conditions":[{"fieldId":"billable","operator":"eq","value":false}]}]}},
