// Copied from lib/services/staffEntityService.ts in the web app (framework-
// agnostic -- only depends on a SupabaseClient instance) so the mobile
// invite-join flow stays behaviourally identical without a cross-bundler
// import across Next.js/Metro.
//
