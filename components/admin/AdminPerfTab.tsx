...
const KIND_LABEL: Record<string, string> = { dashboard: "Dashboard", table: "Table", settings: "Settings", admin: "Admin", marketplace: "Marketplace", page: "Page (auto)", record: "Record dashboard" };
