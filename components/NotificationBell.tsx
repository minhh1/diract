...
// Rail icon + dropdown, mounted in Sidebar.tsx's account cluster. Mirrors
// that file's own company-switcher dropdown idiom exactly (self-contained
// open/close state, a wrapper that stops click propagation so clicks inside
// the panel don't self-close it, and an unconditional document click
// listener that closes it otherwise) rather than depending on any of
// Sidebar's own state, since this needed to be a standalone component.
"use client";
