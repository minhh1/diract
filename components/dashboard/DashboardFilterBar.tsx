...
// Renders a dashboard's configured filter fields (date fields as a date
// picker, relation fields via RelationPicker) as a top toolbar, feeding
// lib/hooks/useDashboardData.ts's filter state.
